...
/**
 * 32-bit floating point number state value.
 *
 * @author Philippe Proulx
 */
class Float32StateValue :
    public SimpleStateValue<float, StateValueType::FLOAT32>
{
public:
    typedef std::shared_ptr<Float32StateValue> SP;
    typedef std::unique_ptr<Float32StateValue> UP;
