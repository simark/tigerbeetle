 ...
 */
#ifndef _TIBEE_COMMON_ABSTRACTJSONRPCMESSAGEDECODER_HPP
#define _TIBEE_COMMON_ABSTRACTJSONRPCMESSAGEDECODER_HPP
...
#endif // _TIBEE_COMMON_ABSTRACTJSONRPCMESSAGEDECODER_HPP
